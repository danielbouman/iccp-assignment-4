...
string1.time_evolution_f90(10,1)    # Start time evolution with: damper (optional), damper delay
# note1 = string1.getWave()         # Get wave when creating a chord
string1.exportSound('test')         # Save as .wav file with: extra text in filename (optional)
