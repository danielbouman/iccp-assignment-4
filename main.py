...
string1 = String('c2',2)            # Define string with: note, duration in seconds
...
string1.exportSound('new_hammer_par')     # Save as .wav file with: extra text in filename (optional)
