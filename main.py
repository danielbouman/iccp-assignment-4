...
string1 = String('c4',10)            # Define string with: note, duration in seconds
...
string1.exportSound('new_hammer_flatterparabola')     # Save as .wav file with: extra text in filename (optional)
